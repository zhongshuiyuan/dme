...
{
    public abstract class DMEDataSource : IDMEDataSource
    {
        /// <summary>
        /// 是否检测连接元数据的有效性
        /// </summary>
        ...
        public DMEDataSource(IDMEDataSourceFactory factory, IPropertySetter properties, Boolean checkMetaInvalid = false)
        {
        ...
        public DMEDataSource(IDMEDataSourceFactory factory, string connectionStr, Boolean checkMetaInvalid = false)
        {
